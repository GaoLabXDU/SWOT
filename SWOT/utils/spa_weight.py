...
def compute_sw(st_exp, st_xy, sc_meta,
               file_path,
               d_pos, d_spot,
               cluster='celltype',
    ...
    Spa_weight, Spa_cost = spatial_weight_cost(d_pos=d_pos,
                                               d_spot=d_spot,
...
def spatial_weight_cost(d_pos, d_spot,
    ...
    if save:
        ...
        spa_weight.to_csv(file_path + 'OptimalTransport/spa_weight.csv', sep=',', index=True, header=True)
        #spa_cost.to_csv(file_path + 'OptimalTransport/spa_cost.csv', sep=',', index=True, header=True)
        print('The spatial weight is saved in ' + file_path + 'OptimalTransport/spa_weight.csv.')
